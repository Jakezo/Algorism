...
public class pra4{
	...
	public static class Bus extends Car{
	    ...
	    public static class GasStation{
			/*
			 * public void fill(Suv suv){ System.out.println("Suv에 기름을 넣습니다."); suv.gas +=
			 * 10; System.out.println("기름이 "+suv.gas+"리터 들어있습니다."); }
			 * 
			 * public void fill(Truck truck){ System.out.println("Truck에 기름을 넣습니다.");
			 * truck.gas += 10; System.out.println("기름이 "+truck.gas+"리터 들어있습니다."); }
			 * 
			 * public void fill(Bus bus){ System.out.println("Bus에 기름을 넣습니다."); bus.gas +=
			 * 10; System.out.println("기름이 "+bus.gas+"리터 들어있습니다."); }
			 */
